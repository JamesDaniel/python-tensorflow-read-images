...
# mnist library has to be downloaded to /tmp/data directory first.
# this file must be run beside the /tensorflow directory.
# this file takes about 10 minutes to execute.
